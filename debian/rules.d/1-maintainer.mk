...
printchanges:
	@baseCommit=$$(git log --pretty=format:'%H %s' | \
		awk '/UBUNTU: '".*Ubuntu-lts-$(prev_fullver)"'$$/ { print $$1; exit }'); \
...
startnewrelease:
	...
	now="$(shell date -R)"; \
	echo "Creating new changelog set for $(release)-$$nextmajor.$$nextminor~precise1..."; \
	echo -e "$(src_pkg_name) ($(release)-$$nextmajor.$$nextminor~precise1) UNRELEASED; urgency=low\n" > $(DEBIAN)/changelog.new; \
